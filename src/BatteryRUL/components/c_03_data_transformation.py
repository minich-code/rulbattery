...
from src.BatteryRUL.entity.configuration_entity import DataTransformationConfig
...
class DataTransformation:
    ...
    def remove_outliers(self, df: pd.DataFrame) -> pd.DataFrame:
        try:
            ...
            # Calculating z-scores on the entire DataFrame 
            ...
            # logging.info(f"Original number of rows: {df.shape[0]}")
            # logging.info(f"Number of rows after filtering: {df_filtered.shape[0]}")
